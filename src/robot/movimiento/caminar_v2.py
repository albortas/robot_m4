...
class Robot:
    ...
    def start_walk_stop(self, track, x_offset, steering_radius, steering_angle, cw, h_amp, v_amp, height, stepl, t,
        ...
        stance_test, stance, t1 = self.initialize_stance_and_time(t, np.zeros(4), np.zeros(4), step_phase)
        ...
        comp, compt, v_amp_t, Msi_comp = self.calculate_compensation(
        ...
        pos = self.calculate_leg_positions(
            stance, t1, tstep, *self.calculate_frame_corners(x_framecenter_comp, y_framecenter_comp, z_framecenter_comp, Ms_updated),
    ...
    def calculate_compensation(self, x_abs_comp, y_abs_comp, x_spot, y_spot, CG, x_offset, kcomp, theta_spot_updated,
                               v_amp, step_phase, t1):
        """
